        ...
        <div className="flex flex-col md:flex-row items-center gap-8 md:gap-16">
          ...
          <div className="w-full md:w-1/2 max-w-md mx-auto">
            <p className="text-text-secondary mb-6">
              Notre modèle emblématique, le Coral Reef noir, incarne l'essence même de MAXASWIMS. Tricoté à la main avec
            ...
            <Button className="btn-primary uppercase tracking-wider">DÉCOUVRIR</Button>
          </div>
        </div>
      </div>
    </section>
